...
public class UploadPDFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goAhead = findViewById(R.id.uploadPDFBtn);
        dynamicText = findViewById(R.id.dynamicTextView);
        ...
        goAhead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(title.isEmpty()) {
                    ...
                    Toast.makeText(UploadPDFActivity.this, "Please select a PDF before Upload", Toast.LENGTH_SHORT).show();
                } else {
                    uploadPdf();
                }
            }
        ...
        reference.putFile(pdfData)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(UploadPDFActivity.this, "ooops!! Something Went Wrong, Please try again in few seconds : |", Toast.LENGTH_SHORT).show();
                    }
                });
    }
